...
const QUICK_OPTIONS: QuickOption[] = [
  {
    ...
    message: "Can you tell me about Anser's main skills and experience?",
  },
  {
    text: "🚀 Project Collaboration",
    message:
      "I'm interested in working with Anser. What's the best way to start?",
  },
  {
    text: "💼 Past Projects",
    message: "Could you share some examples of Anser's past projects?",
  },
  {
    text: "⚡ AI Integration",
    message: "What kind of AI features can Anser implement in projects?",
  },
];
